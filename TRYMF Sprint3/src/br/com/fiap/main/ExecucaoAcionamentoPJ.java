...
import br.com.fiap.beans.SeguradoPj;
import br.com.fiap.beans.Veiculo;

public class ExecucaoAcionamentoPJ {
	...
	public static void main(String[] args) {
		...
		SeguradoPj objPj = new SeguradoPj();
		objPj.setId(inteiro("Digite o Id do Segurado: "));
		objPj.setNome(texto("Digite o nome do Segurado: ").toUpperCase());
		objPj.setCnpj(texto("Digite seu email: ").toUpperCase());
		objPj.setCnpj(texto("Digite seu CNPJ: ").toUpperCase());
		
		//String marca, String modelo, String placa, int ano
		Veiculo objVeiculo = new Veiculo();
		objPj.setVeiculo(objVeiculo);
		...
		acionamento.setIdSegurado(objPj);
		...
		System.out.println("SEGURADO ID: " + objPj.getId() + 
				"\nNOME: "+ objPj.getNome() +
				"\nTIPO: " + objPj.identificador() +
				"\n" +
